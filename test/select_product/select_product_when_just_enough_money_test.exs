defmodule SelectProductWhenJustEnoughMoneyTest do
  use ExUnit.Case
  ...
  test "it accepts COLA selection when just enough coins are inserted", context do
  ...
  test "it accepts CHIPS selection when just enough coins are inserted", context do
    machine = context.machine
    |> VendingMachine.insert_coin(:quarter)
    |> VendingMachine.insert_coin(:quarter)
  ...
  test "it accepts CANDY selection when just enough coins are inserted", context do
    machine = context.machine
    |> VendingMachine.insert_coin(:quarter)
    |> VendingMachine.insert_coin(:quarter)
